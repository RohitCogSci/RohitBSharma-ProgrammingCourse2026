...
// int main() {
//     cout << setw(10) << "Name" << setw(5) << "CGPA" << endl;   // only "Name" is padded!
//     return 0;
// }
...
// int main() {
//     cout << right << setfill('R') << setw(7) << 42 << endl;   // 42000, not 00042!
//     return 0;
// }
...
// int main() {
//     cout << setw(1) << "Programming Course" << endl;
//     return 0;
// }
...
// int main() {
//     int x = 5;
//     cout << (7 < x < 3) << endl;   // 1 (true)! Even though 5 is not < 3
//     return 0;
// }       // here the boolean value is taken as the iput for the next comparison, that is why we get 1 even when 5<3 
